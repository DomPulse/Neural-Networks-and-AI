...
path1 = "C:\\Users\\Dominic Mann\\Documents\\python\\Color CNN\\Images"    #path of folder of images
path2 = "C:\\Users\\Dominic Mann\\Documents\\python\\Color CNN\\ImagesG"  #path of folder to save images
...
with open("testmodel.json", "w") as json_file:
